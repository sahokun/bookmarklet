...
(await $nuxt.$store.$laboratoryService.estimatePurchaseAmount(c,1E3*a)).amount;console.log("\u76ee\u6a19\u4fa1\u683c:",e);for(let f=0;20>f;f++){console.log("\u30eb\u30fc\u30d7\u56de\u6570:",f+1);console.log("\u4e0b\u9650:",a,"\u4e0a\u9650:",b,"\u76ee\u6a19:",e);var d=Math.ceil((a+b)/2*100)/100;console.log("\u4e2d\u9593\u5024:",d);let g=(await $nuxt.$store.$laboratoryService.estimatePurchaseAmount(c,1E3*d)).amount;console.log("\u4e2d\u9593\u5024\u306e\u4fa1\u683c:",g);g===e?(a=d,console.log("midPrice === targetPrice"),
