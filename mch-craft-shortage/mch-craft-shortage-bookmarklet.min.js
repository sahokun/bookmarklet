...
""),10);a=a[1].querySelector(".amount");a=parseInt(a.textContent.replace(/,/g,""),10);a=e-a;if(0<a){const d=await window.$nuxt.$store.$laboratoryService.estimatePurchaseAmount(b,1E3*e);h+=d.amount;b=await window.$nuxt.$store.$laboratoryService.estimatePurchaseAmount(b,1E3*a);k+=b.amount;g.push(`${c}, \u4e0d\u8db3\u6570: ${a}(${b.amount}GUM), \u5fc5\u8981\u6570: ${e}(${d.amount}GUM)`)}}0<g.length?alert(`${f}\n\n${g.join("\n")}\n\n\u4e0d\u8db3\u5206\u984d: ${k}GUM, \u7dcf\u984d: ${h}GUM`):alert("\u5fc5\u8981\u306a\u7d20\u6750\u306f\u3059\u3079\u3066\u6240\u6301\u3057\u3066\u3044\u307e\u3059\u3002")}
