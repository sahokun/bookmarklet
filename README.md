...
```
javascript:(function(){var b=document.querySelector(".unit__heroImage--original img, .unit__heroImage img").getAttribute("src").match(/\/([^\/]+)\.png$/);b=parseInt(b[1]);var f=Array.from(document.querySelectorAll(".unit__skills.unit__section .unit__section__activeSkileName")).map(a=>a.textContent);const l=window.__NUXT__.state.skill.masters,m=window.__NUXT__.state.extension.masters;var d=f.map(a=>{const c=l.find(g=>g.name.ja===a).skillId,h=m.find(g=>g.active===c);return[h?h.extensionType:c,h?"extension":
...
b=window.mchsim_teamcode_list.length;if(3>b)alert(`${b}\u3064\u76ee\u306e\u30b3\u30fc\u30c9\u3092\u8a18\u61b6\u3057\u307e\u3057\u305f\u3002`);else{b=window.mchsim_teamcode_list.slice(-3);const a=JSON.stringify(b).replace(/"/g,"");navigator.clipboard.writeText(a).then(()=>alert("3\u3064\u306e\u30b3\u30fc\u30c9\u3092\u30af\u30ea\u30c3\u30d7\u30dc\u30fc\u30c9\u306b\u30b3\u30d4\u30fc\u3057\u307e\u3057\u305f\uff01\n\n"+a)).catch(c=>alert("\u30af\u30ea\u30c3\u30d7\u30dc\u30fc\u30c9\u3078\u306e\u30b3\u30d4\u30fc\u306b\u5931\u6557\u3057\u307e\u3057\u305f: "+
c))}})();
```
...
javascript:(function() {
    const imgTag = document.querySelector('.unit__heroImage--original img, .unit__heroImage img');
